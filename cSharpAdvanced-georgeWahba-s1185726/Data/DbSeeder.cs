    ...
    public static class DbSeeder
    {
        ...
        private static void SeedLocations(cSharpAdvanced_georgeWahba_s1185726Context context)
        {
            if (!context.Location.Any())
            {
                var locations = new[]
                {
                    new Location { Title = "Cozy Apartment", SubTitle = "Downtown", Description = "A cozy apartment located in the heart of downtown.", Type = Location.LocationType.Apartment, Rooms = 2, NumberOfGuests = 4, Feature = (Location.Features)(int)(Location.Features.Wifi | Location.Features.Smoking), PricePerDay = 100, LandlordId = 1 },
                    new Location { Title = "Seaside Cottage", SubTitle = "Beachfront", Description = "A charming seaside cottage with direct access to the beach.", Type = Location.LocationType.Cottage, Rooms = 3, NumberOfGuests = 6, Feature = (Location.Features)(int)(Location.Features.PetsAllowed | Location.Features.Wifi), PricePerDay = 150, LandlordId = 2 },
                    new Location { Title = "Mountain Chalet", SubTitle = "Ski Resort", Description = "A cozy mountain chalet nestled in a ski resort area.", Type = Location.LocationType.Chalet, Rooms = 4, NumberOfGuests = 8, Feature = (Location.Features)(int)(Location.Features.TV | Location.Features.Bath), PricePerDay = 200, LandlordId = 3 },
                    new Location { Title = "Luxury Hotel Suite", SubTitle = "City Center", Description = "A luxurious hotel suite located in the bustling city center.", Type = Location.LocationType.Hotel, Rooms = 1, NumberOfGuests = 2, Feature =(Location.Features) (int)(Location.Features.Breakfast | Location.Features.Wifi), PricePerDay = 250, LandlordId = 4 },
                    new Location { Title = "Spacious House", SubTitle = "Suburban Area", Description = "A spacious house situated in a peaceful suburban area.", Type = Location.LocationType.House, Rooms = 5, NumberOfGuests = 10, Feature = (Location.Features)(int)(Location.Features.Wifi | Location.Features.PetsAllowed | Location.Features.TV), PricePerDay = 300, LandlordId = 5 }
                };
